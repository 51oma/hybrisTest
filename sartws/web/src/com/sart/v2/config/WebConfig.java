 ...
 */
package com.sart.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import com.sart.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "sartws.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "sartws.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "sartws.oauth2.tokenUrl";

	private static final String DESC = "sartws.v2.description";
	private static final String TITLE = "sartws.v2.title";
	private static final String VERSION = "sartws.v2.version";
