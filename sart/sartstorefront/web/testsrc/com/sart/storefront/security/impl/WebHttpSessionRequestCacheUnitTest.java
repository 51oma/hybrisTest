...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/sartstorefront/electronics/en",
						"https://electronics.local:9002/sartstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/sartstorefront/electronics/en",
						"https://electronics.local:9002/sartstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/sartstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/sartstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/sartstorefront/electronics/en",
						"https://electronics.local:9002/sartstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/sartstorefront",
						"https://electronics.local:9002/sartstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/sartstorefront",
						"https://electronics.local:9002/sartstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/sartstorefront/electronics/en",
						"https://electronics.local:9002/sartstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
