 ...
 */
package com.sart.core.constants;

/**
 * Global class for all SartCore constants. You can add global constants for your extension into this class.
 */
public final class SartCoreConstants extends GeneratedSartCoreConstants
{
	public static final String EXTENSIONNAME = "sartcore";


	private SartCoreConstants()
	{
		//empty
	}
