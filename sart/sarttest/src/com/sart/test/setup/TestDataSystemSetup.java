...
import com.sart.test.constants.SartTestConstants;
import com.sart.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = SartTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/sarttest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/sarttest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/sarttest/import/cstickets.impex");
			...
			importImpexFile(context, "/sarttest/import/csquotes.impex");
		}
	}
}
