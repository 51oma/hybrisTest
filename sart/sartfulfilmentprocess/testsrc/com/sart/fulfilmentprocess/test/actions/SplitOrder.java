 ...
 */
package com.sart.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(SartFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(SartFulfilmentProcessConstants.PARENT_PROCESS);
